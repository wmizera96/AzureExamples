...
namespace AzureExamples.Data
{
    ...
    // Scaffold-DbContext "Data Source=localhost;Initial Catalog=example-database;Integrated Security=True" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Data

    public partial class ExampleDatabaseContext : DbContext
    {
        private IConfiguration _configuration;
        public ExampleDatabaseContext(IConfiguration configuration)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECAA4018BF7");
